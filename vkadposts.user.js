...
var actualCode = '(' + function() {
	var keywords = [
		...
		"епост этой записи", "епост данной записи", "епост записи", "оделиться записью",
		...
		"ступите в группу", "ступите в нашу группу", "ступаем в группу", "ступайте в группу", "ступить в группу", "Вступай",
		"ыть участником", "ыть подписчиком", "ыть нашим подписчиком",
		"ДОБАВЬ", "ДОБАВЛЯЙТЕ", "обавляйся в друзья", "обавляйтесь в друзья",
		...
		"Подробности акции на странице", "знать подробнее", "знай подробнее",
