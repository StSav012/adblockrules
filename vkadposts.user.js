...
var actualCode = '(' + function() {
	var keywords = [
		...
		"оделиться записью", "бонус за репост", "лайк и репост", "Забирай на стену",
		...
		"ступайте в группу", "Вступай", "ыть нашим подписчиком",
		"Зайди поглазеть на эти посты",
		"Регистрация всего за", "Оставьте заявку", "Оставь заявку", "Регистрация пока бесплатна",
		...
		"Подписаться на канал можно здесь", "Подписываемся!",
