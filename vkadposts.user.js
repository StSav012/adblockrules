...
var actualCode = '(' + function() {
	var keywords = [
		"РЕПОСТ", "REPOST",
		"делать репост", "делать рeпoст" /*WTF*/, "делать \"репост\"", "дeлaйтe рeпoст", "делай репост", "делавшему репост",
		"епост этой записи", "епост данной записи", "епост записи", "оделиться записью", "оделиться этой записью",
		"репостни этот пост", "делись этим сообщением",
		...
		"ВСТУПАЙТЕ", "ступите в группу", "ступите в нашу группу", "ступаем в группу", "ступайте в группу",
		"ступить в группу", "Вступай", "ступить в сообщество",
		...
		"качать бесплатно",
		"ПОДАРОК",
		"СКИДКА", "СКИДКОЙ", "Выбирай со скидкой", "с нереальными скидками", "дарим скидку", "Скидки на весь ассортимент",
		"За репост скидка",
		...
		"ПОДПИШИСЬ", "ПОДПИСЫВАЙСЯ", "одпишись", "одпишитесь на", "одписывайтесь на ", "одписывайтесь - ", "одписывайся", "одписываемся!",
