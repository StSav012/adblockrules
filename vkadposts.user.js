...
var actualCode = '(' + function() {
	var keywords = [
		...
		"лайки и репосты записи", "озыгрыш по репосту",
		...
		"Подпишись", "подпишитесь на", "Подписывайся на", "Быть подписчиком", "Быть подписанным на", "Подписывайтесь - ", "Подписаться на группу",  "одписывайтесь на группу",
		"ЗАКАЖИТЕ", "КУПИТЬ", "Заказать можно тут",
		"Подарок можно забрать", "Вы сможете забрать ваш подарок",
