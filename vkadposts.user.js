...
var actualCode = '(' + function() {
	var keywords = [
		...
		"Подпишись", "подпишитесь на", "Подписывайся на", "Быть подписчиком", "Быть подписанным", "быть подписанным", "Подписывайтесь - ", "Подписаться на группу",  "одписывайтесь на группу",
		"ЗАКАЖИТЕ", "КУПИТЬ", "Заказать можно тут", "Подробнее здесь", 
