...
var actualCode = '(' + function() {
	var keywords = [
		...
		"репост этой записи", "оделиться записью",
		...
		"АКЦИЯ", "Мега-Акция", "Акция до конца",
		...
		"ыть подписчиком", "ыть подписанным", "одписался на",
		"одписаться на группу", "одписаться на канал можно здесь", "одписаться +", "Приглашаем подписаться на",
